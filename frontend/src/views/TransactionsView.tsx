    ...
    <div className="flex flex-col gap-6 p-6 md:p-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <h1 className="text-[13px] font-semibold text-foreground">Transactions</h1>
          ...
          {flaggedCount > 0 && (
            <span className="mono rounded-md border border-red-200 bg-red-50 px-2 py-0.5 text-[10px] uppercase tracking-widest text-red-700">
            ...
            <TableHeader className="sticky top-0 z-10">
              <TableRow className="border-zinc-100 hover:bg-transparent">
                {[
                  ...
                  <TableHead key={h} className={`bg-zinc-50/90 text-[11px] font-medium uppercase tracking-widest text-muted-foreground ${cls}`}>
                    {h}
                  </TableHead>
                ))}
              </TableRow>
              ...
              {loading ? (
                ...
                filtered.map(tx => (
                  <TableRow key={tx.id} className="border-zinc-100 transition-colors hover:bg-zinc-50">
                    ...
                    <TableCell className="mono text-xs font-medium">{tx.account_id}</TableCell>
